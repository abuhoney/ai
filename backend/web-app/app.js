...
async function initConfig() {
  ...
  // If backendUrl is empty, use same origin (web app served from backend)
  BACKEND_URL = CONFIG.backendUrl || window.location.origin;
  // If AndroidBridge overrides backendUrl, use that
  if (cfgOverride && cfgOverride.backendUrl) {
    BACKEND_URL = cfgOverride.backendUrl;
  }
